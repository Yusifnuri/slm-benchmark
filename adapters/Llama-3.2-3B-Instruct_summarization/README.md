...
# Llama-3.2-3B-Instruct — Abstractive summarisation adapter

A LoRA adapter that specialises `meta-llama/Llama-3.2-3B-Instruct` (3.21 B parameters) for a single enterprise task: it produces a two-to-three sentence summary of a news article.
...
|---|---|
| ROUGE-L | **0.186** |
| Mean latency, batch 1 | 1761 ms |
| Cost per 1M generated tokens | USD 15.25 |
...
model = PeftModel.from_pretrained(base, "<your-hf-username>/Llama-3.2-3B-Instruct_summarization")
